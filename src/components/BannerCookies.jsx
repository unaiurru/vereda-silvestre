  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 p-3 md:p-5 pointer-events-none">
      <div className="max-w-3xl mx-auto pointer-events-auto">
        <div className="rounded-2xl bg-brand text-crema-clara shadow-2xl shadow-stone-900/30 p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center gap-4">
          <div className="hidden md:flex w-11 h-11 rounded-xl bg-crema-clara/10 shrink-0 items-center justify-center">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <button
              onClick={aceptar}
              className="flex-1 md:flex-none rounded-full bg-crema-clara text-brand px-6 py-2.5 text-[13px] font-medium hover:bg-white transition-colors whitespace-nowrap"
            >
              Aceptar y continuar
            </button>
            <button
              onClick={() => setVisible(false)}
              className="w-11 h-11 shrink-0 rounded-full bg-crema-clara/10 hover:bg-crema-clara/20 flex items-center justify-center transition-colors"
